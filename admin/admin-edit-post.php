				...
				<div class="col-lg-12 col-md-12 col-12">
					<div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
						<div class="mb-2 mb-lg-0">
							<h1 class="mb-1 h2 font-weight-bold">Edit Post</h1>
							<!-- Breadcrumb -->
					...
					<div class="card border-0 mb-4">
						...
						<div class="card-body">
							...
							<form class="dropzone mt-4 border-dashed" enctype="multipart/form-data" method="POST">
								...
								<div class="mt-4">
									...
									<div class="row">
										<div class="form-group col-md-9">
											...
											<input type="text" id="postTitle" name="title" class="form-control text-dark" value="<?=$pmr['Title']?>" placeholder="Post Title"/>
								...
								<!-- button -->
								<button type="submit" name="edit" class="btn btn-primary">Edit Post</button>
							</form>
						</div>
					</div>
				</div>
