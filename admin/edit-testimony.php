<?php
 ...
 if (isset($_POST['edit'])){
        ...
        $edit_testimony = DB::update('testimony', [
          'Quote' => $testimony,
        ], "id_testimony=%i", $id = $_GET['id']);
        if ($edit_testimony){
          echo "<script>alert('Testimony berhasil Diedit.');window.location='testimony.php';</script>";
        }else{
  ...
  //awal cek
  $cek = $_GET['id'];
  $pmr = DB::query("SELECT * FROM testimony WHERE id_testimony = $cek")[0];
				...
				<div class="col-lg-12 col-md-12 col-12">
					<div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
						<div class="mb-2 mb-lg-0">
							<h1 class="mb-1 h2 font-weight-bold">Edit Testimony</h1>
							<!-- Breadcrumb -->
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-12">
					...
					<div class="card border-0 mb-4">
						...
						<div class="card-header">
							<h4 class="mb-0">Edit Testimony</h4>
						</div>
						<!-- Card body -->
						<div class="card-body">
								...
								<div class="mt-4">
									...
									<div class="row">
										<div class="form-group col-md-9">
                                            ...
                                            <textarea class="form-control" name="testimony" placeholder="Masukan Quotes" required ><?=$pmr['Quote']?></textarea>
										</div>

									</div>
								</div>
								<!-- button -->
								<button type="submit" name="edit" class="btn btn-primary">Edit Quotes</button>
							</form>
						</div>
					</div>
				</div>
