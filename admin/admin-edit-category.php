<?php
 ...
 if (isset($_POST['edit'])){
        ...
        $edit_category = DB::update('category', [
          'Name' => $title,
        ], "id=%i", $id = $_GET['edt']);
        if ($edit_category){
          echo "<script>alert('Category berhasil Diedit.');window.location='admin-category.php';</script>";
        }else{
  ...
  //awal cek
  $cek = $_GET['edt'];
  $pmr = DB::query("SELECT * FROM category WHERE id = $cek")[0];
				...
				<div class="col-lg-12 col-md-12 col-12">
					<div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
						<div class="mb-2 mb-lg-0">
							<h1 class="mb-1 h2 font-weight-bold">Edit Category</h1>
							<!-- Breadcrumb -->
						...
						<div>
							<a href="admin-category.php" class="btn btn-outline-white">Back Category</a>
						</div>
					</div>
				</div>
			</div>
								...
								<div class="mt-4">
									...
									<div class="row">
										<div class="form-group col-md-9">
											<!-- Title -->
											<label for="postTitle" class="form-label">Katego Lama</label>
											<input type="text" id="postTitle" class="form-control text-dark " value="<?=$pmr['Name']?>" placeholder="Post Title"/><br><br>
											<label for="postTitle" class="form-label">Kategori Baru</label>
